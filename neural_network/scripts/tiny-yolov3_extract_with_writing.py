...
def main_IE_infer():
    ...
    model_xml = "/home/nirma/test_videos/models/yolo_tiny/FP32/frozen_tiny_yolo_v3.xml" #<--- CPU
    ...
    cap = cv2.VideoCapture("/home/nirma/test_videos/videos/national_geo.mp4")
    ...
    fps_2 = 30
    capSize = (1280, 720) 
    out = cv2.VideoWriter('/home/nirma/test_videos/videos/nova.avi', fourcc, fps_2, capSize)

    time.sleep(1)

    plugin = IEPlugin(device=args.device)
    if "CPU" in args.device:
        plugin.add_cpu_extension("/home/nirma/OpenVINO-YoloV3/lib/libcpu_extension.so")
